...
_ufc.SHARED_PTR_DISOWN_swigconstant(_ufc)
SHARED_PTR_DISOWN = _ufc.SHARED_PTR_DISOWN

_ufc.UFC_VERSION_MAJOR_swigconstant(_ufc)
UFC_VERSION_MAJOR = _ufc.UFC_VERSION_MAJOR

_ufc.UFC_VERSION_MINOR_swigconstant(_ufc)
UFC_VERSION_MINOR = _ufc.UFC_VERSION_MINOR

_ufc.UFC_VERSION_MAINTENANCE_swigconstant(_ufc)
UFC_VERSION_MAINTENANCE = _ufc.UFC_VERSION_MAINTENANCE

_ufc.UFC_VERSION_RELEASE_swigconstant(_ufc)
UFC_VERSION_RELEASE = _ufc.UFC_VERSION_RELEASE

_ufc.interval_swigconstant(_ufc)
interval = _ufc.interval

_ufc.triangle_swigconstant(_ufc)
triangle = _ufc.triangle

_ufc.quadrilateral_swigconstant(_ufc)
quadrilateral = _ufc.quadrilateral

_ufc.tetrahedron_swigconstant(_ufc)
tetrahedron = _ufc.tetrahedron

_ufc.hexahedron_swigconstant(_ufc)
...
dofmap.num_element_dofs = new_instancemethod(_ufc.dofmap_num_element_dofs, None, dofmap)
...
class integral(object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _ufc.delete_integral
integral.enabled_coefficients = new_instancemethod(_ufc.integral_enabled_coefficients, None, integral)
integral_swigregister = _ufc.integral_swigregister
integral_swigregister(integral)

class cell_integral(integral):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
...
class exterior_facet_integral(integral):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
...
class interior_facet_integral(integral):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
...
class vertex_integral(integral):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _ufc.delete_vertex_integral
vertex_integral.tabulate_tensor = new_instancemethod(_ufc.vertex_integral_tabulate_tensor, None, vertex_integral)
vertex_integral_swigregister = _ufc.vertex_integral_swigregister
vertex_integral_swigregister(vertex_integral)

class custom_integral(integral):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _ufc.delete_custom_integral
custom_integral.num_cells = new_instancemethod(_ufc.custom_integral_num_cells, None, custom_integral)
custom_integral.tabulate_tensor = new_instancemethod(_ufc.custom_integral_tabulate_tensor, None, custom_integral)
custom_integral_swigregister = _ufc.custom_integral_swigregister
custom_integral_swigregister(custom_integral)
...
form.original_coefficient_position = new_instancemethod(_ufc.form_original_coefficient_position, None, form)
...
form.max_cell_subdomain_id = new_instancemethod(_ufc.form_max_cell_subdomain_id, None, form)
form.max_exterior_facet_subdomain_id = new_instancemethod(_ufc.form_max_exterior_facet_subdomain_id, None, form)
form.max_interior_facet_subdomain_id = new_instancemethod(_ufc.form_max_interior_facet_subdomain_id, None, form)
form.max_vertex_subdomain_id = new_instancemethod(_ufc.form_max_vertex_subdomain_id, None, form)
form.max_custom_subdomain_id = new_instancemethod(_ufc.form_max_custom_subdomain_id, None, form)
...
form.has_vertex_integrals = new_instancemethod(_ufc.form_has_vertex_integrals, None, form)
form.has_custom_integrals = new_instancemethod(_ufc.form_has_custom_integrals, None, form)
...
form.create_vertex_integral = new_instancemethod(_ufc.form_create_vertex_integral, None, form)
form.create_custom_integral = new_instancemethod(_ufc.form_create_custom_integral, None, form)
...
form.create_default_vertex_integral = new_instancemethod(_ufc.form_create_default_vertex_integral, None, form)
form.create_default_custom_integral = new_instancemethod(_ufc.form_create_default_custom_integral, None, form)
